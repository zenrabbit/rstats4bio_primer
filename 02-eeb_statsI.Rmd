...
#### Adventure time {-}  
Here are a deeper set of quanitified life [data](https://figshare.com/articles/dataset/Quantified_life/12803105). Explore whether movement predicts total sleep or its efficiency. Plot out some patterns first, then, do a regression.      
